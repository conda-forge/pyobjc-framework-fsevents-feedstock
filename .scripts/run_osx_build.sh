...
validate_recipe_outputs "pyobjc-framework-fsevents-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="pyobjc-framework-fsevents-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi